...
description: "Skill for agent-payment-x402"
version: 1.0.0
---

---
name: agent-payment-x402
description: Add x402 payment execution to AI agents â€” per-task budgets, spending controls, and non-custodial wallets via MCP tools. Use when agents need to pay for APIs, services, or other agents.
origin: community
---
...
### x402 Protocol
x402 extends HTTP 402 (Payment Required) into a machine-negotiable flow. When a server returns `402`, the agent's payment tool automatically negotiates price, checks budget, signs a transaction, and retries â€” no human in the loop.
