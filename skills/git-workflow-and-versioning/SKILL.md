...
- Disabling/re-enabling branch protection for self-managed repos
- Direct merge after protection is disabled (no self-approval needed)
- CHANGELOG.md and pyproject.toml version updates
